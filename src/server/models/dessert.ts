const dessertData = [
  {
    ...
    description: "Can't Resist This All Time Classic",
  ...
  },
  {
    name: "Pecan Pie",
    image: "pecanPie.jpg",
    description: "Make You Wanna Slap Yo' momma",
    title: "Pecan Pie",
...
// Insert dessert data into the database
dessert.insertMany(dessertData)
